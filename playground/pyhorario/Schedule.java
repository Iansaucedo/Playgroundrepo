public class Schedule {
    ...
    public void exchangeSubject( int firstDay, int firstHour, int SecondDay, int secondHour){
       Subject holds = subjects[firstDay][firstHour];
       subjects[firstDay][firstHour] = subjects[SecondDay][secondHour];
       subjects[SecondDay][secondHour] = holds;
    ...
    public static void main(String[] args) {
        ...
        schedule.exchangeSubject(0, 0, 1, 0);
